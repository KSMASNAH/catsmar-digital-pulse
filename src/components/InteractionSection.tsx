...
export const InteractionSection = () => {
  const pieData = [
    { name: "Reacciones", value: 1150, color: "#0ea5e9" },
    { name: "Comentarios", value: 210, color: "#1e40af" }
  ];
    ...
    <Card className="p-6 shadow-lg">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="text-center">
          <p className="text-3xl font-bold text-slate-700">210</p>
          <p className="text-sm text-slate-600">Comentarios</p>
        </div>
        <div className="text-center">
          <p className="text-3xl font-bold text-slate-700">95</p>
          <p className="text-sm text-slate-600">Compartidos</p>
        </div>
        <div className="text-center">
          <p className="text-3xl font-bold text-slate-700">1,150</p>
