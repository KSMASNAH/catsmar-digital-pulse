...
export const LoyaltySection = () => {
  const loyaltyData = [
    { month: "Mayo", nuevos: 11, recurrentes: 31 },
    { month: "Junio", nuevos: 34, recurrentes: 42 },
    { month: "Julio", nuevos: 33, recurrentes: 76 }
  ];

  const retentionData = [
    { name: "Retenidos", value: 45, color: "#0ea5e9" },
    { name: "No retenidos", value: 55, color: "#e2e8f0" }
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="text-center">
            ...
            <p className="text-3xl font-bold text-green-600">$54.60</p>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-2xl font-bold text-slate-700">45%</span>
              </div>
            </div>
          </div>
        </div>
