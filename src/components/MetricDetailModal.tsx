    ...
    switch (metricType) {
      case "alcance":
        return {
          ...
          chartData: [
            { mes: "Mayo", facebook: 4200, instagram: 3800, whatsapp: 1500 },
            { mes: "Junio", facebook: 4500, instagram: 4100, whatsapp: 1800 },
            { mes: "Julio", facebook: 4800, instagram: 4300, whatsapp: 2100 }
          ],
          insights: [
            "Crecimiento del 14.3% comparado con el período anterior",
            "Instagram muestra el mayor crecimiento (13.2%)",
